...
Measured::Volume = Measured.build do
  ...
  # The above are copied from the gem. Below are my additions
  unit :tsp, value: "0.00130208 us_gal", aliases: []
  unit :tbsp, value: "3 tsp", aliases: [:Tbsp]
  unit :dash, value: "0.5 tsp", aliases: []
  unit :cup, value: "8 us_oz"
  unit :unknown, value: "1 tsp"

  # I'm not sure this is setting the cache right, but that's a tomorrow problem
  cache Measured::Cache::Json, "barkeep-volume.json"
end