RSpec.shared_examples 'a user-scoped model' do |factory_name|
  ...
  it 'includes user-owned and shared records together' do
    expect(described_class.for_user_or_shared(owner)).to contain_exactly(owned_record, shared_record)
  end
